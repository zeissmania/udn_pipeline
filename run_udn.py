...
ps.add_argument('-noam', '-skip_amelie', help="""don't run the amelie match""", action='store_true')
...
if args.new:
    ...
    flist_remove = ['intermediate', '*.err', '*.log', 'err_amelie*', 'UDN*amelie*', 'UDN*merged.sorted.*', 'omim_*', 'merge*' ]
